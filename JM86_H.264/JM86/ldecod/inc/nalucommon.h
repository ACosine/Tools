...
#define NALU_TYPE_SLICE    1	//++ 非IDR图像的编码片
#define NALU_TYPE_DPA      2	//++ 编码图像A类数据分割
#define NALU_TYPE_DPB      3	//++ 编码图像B类数据分割	
#define NALU_TYPE_DPC      4	//++ 编码图像C类数据分割
#define NALU_TYPE_IDR      5	//++ IDR图像的编码片
#define NALU_TYPE_SEI      6	//++ SEI NAL单元
#define NALU_TYPE_SPS      7	//++ 序列参数集
#define NALU_TYPE_PPS      8	//++ 图像参数集
#define NALU_TYPE_AUD      9	//++ NAL单元的存取单元定界符
