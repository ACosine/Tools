...
/* Range table for  LPS */ 
const byte rLPS_table_64x4[64][4]=                       //最小概率符号的表格
{
  { 128, 176, 208, 240},
  { 128, 167, 197, 227},
  { 128, 158, 187, 216},
...
const unsigned short AC_next_state_MPS_64[64] =    //MPS大概率符号
{
...
const unsigned short AC_next_state_LPS_64[64] =    //LPS小概率符号
{
  0, 0, 1, 2, 2, 4, 4, 5, 6, 7,
 ...
 ************************************************************************
 */
DecodingEnvironmentPtr arideco_create_decoding_environment()//给解码环境结构元素分配内存
{
 ...
 ***********************************************************************
 */
void arideco_delete_decoding_environment(DecodingEnvironmentPtr dep)//释放解码环境结构元素内存
{
  if (dep == NULL)
  {
...
void arideco_start_decoding(DecodingEnvironmentPtr dep, unsigned char *cpixcode,
                            int firstbyte, int *cpixcode_len, int slice_type )//初始化算术编码的解码环境
{
